    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonetaryAccounts", x => new { x.Id, x.BetterExpensesUserId });
                    table.ForeignKey(
                        name: "FK_MonetaryAccounts_Users_BetterExpensesUserId",
                        column: x => x.BetterExpensesUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonetaryAccounts_BetterExpensesUserId",
