...
namespace BetterExpenses.Common.Migrations
{
    ...
    [Migration("20240313042431_AddAdditionalTaskColumns")]
    partial class AddAdditionalTaskColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BetterExpenses.Common.Models.Tasks.CalculatorTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator<string>("TaskType").HasValue("CalculatorTask");
            ...
            modelBuilder.Entity("BetterExpenses.Common.Models.User.UserMonetaryAccount", b =>
                {
                    ...
                    b.HasKey("Id", "BetterExpensesUserId");

                    b.HasIndex("BetterExpensesUserId");
            ...
            modelBuilder.Entity("BetterExpenses.Common.Models.Tasks.FetchAccountsTask", b =>
                {
                    b.HasBaseType("BetterExpenses.Common.Models.Tasks.CalculatorTask");

                    b.Property<bool>("Overwrite")
                        .HasColumnType("boolean");

                    b.HasDiscriminator().HasValue("fetch_accounts");
                });

            modelBuilder.Entity("BetterExpenses.Common.Models.Tasks.FetchExpensesTask", b =>
                {
                    b.HasBaseType("BetterExpenses.Common.Models.Tasks.CalculatorTask");

                    b.Property<DateTime>("FetchTill")
                        .HasColumnType("timestamp with time zone");

                    b.HasDiscriminator().HasValue("fetch_expenses");
                });
            ...
            modelBuilder.Entity("BetterExpenses.Common.Models.Tasks.ProcessExpensesTask", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("process_expenses");
                });
